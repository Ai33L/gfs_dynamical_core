...
if operating_system == "Darwin":
    ...
    default_link_args = []
    os.environ["LDSHARED"] = (
        os.environ["CC"] + " -bundle -undefined dynamic_lookup -arch arm64"
    )
...
setup(
    ...
    ext_modules=[
        Extension(
            ...
            extra_link_args=[
                "-fopenmp",
                lib_path_list[0] + "/libgfs_dycore.a",
                lib_path_list[0] + "/libshtns_omp.a",
                lib_path_list[0] + "/libfftw3_omp.a",
                lib_path_list[0] + "/libfftw3.a",
                openblas_path,
            ]
            + default_link_args,
        ),
